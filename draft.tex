...
Subfigures (b) and (d) show the edge spectrum for class AI and A, respectively. In both cases, the edge modes are split from zero.
...
%where $D$ is the diagonal Hamiltonian, $H=UDU^\dagger$. 
