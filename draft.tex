...
In the following sections, we show that the Zak phase can be recovered from the EOS.
...
In order to reduce these, we are going to choose $A$ as half the system in the reminder of the manuscript.
