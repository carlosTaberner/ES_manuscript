...
%Note that this procedure is not necessary when the only degeneracy is at eigenvalues $1$ and $0$, like in Fig. \ref{huang}.b, as discussed above. \carlos{I need to explain a bit more how this works with the symmetries  ect.}
