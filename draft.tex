...
\makebox[0pt]{
\subfloat[$\kappa_i$]{
  \includegraphics[width=35mm]{wan2_kap.pdf}
}
\subfloat[EOS (black) and $\chi_s$ mod $1$ (green)]{\includegraphics[width=35mm]{wan2_EOS.pdf}
}
}\hspace{0mm}

\makebox[0pt]{
\subfloat[Average position of the EOS eigenstates (blue) and Wannier states (red) around the threshold that separates the left and right sector (black).]{
  \includegraphics[width=35mm]{wan2_wan.pdf}
}
\subfloat[$\chi_s$ obtained using the appropiate left-right threshold (black), Zak phase (red) and $\bar{\chi}$ (dashed blue).]{\includegraphics[width=35mm]{wan2_essum.pdf}
}
}
\caption{Parameters used are: $t=1,t'=-2,m=0,\kappa'=0$. With the profile of $\kappa_i$ shown in (a) the width of $\chi_s$ is larger than one and therefore Eq.\ref{eq:inh_fixed} cannot be employed.}
\label{fig:wan1}
\end{figure}
...
\makebox[0pt]{
\subfloat[$\kappa_i$]{
  \includegraphics[width=35mm]{wan_kap.pdf}
}
\subfloat[EOS (black) and $\chi_s$ mod $1$ (green)]{\includegraphics[width=35mm]{wan_EOS.pdf}
}
}\hspace{0mm}

\makebox[0pt]{
\subfloat[Average position of the EOS eigenstates (blue) and Wannier states (red) around the threshold that separates the left and right sector (black).]{
  \includegraphics[width=35mm]{wan_wan.pdf}
}
\subfloat[$\chi_s$ obtained using the appropiate left-right threshold (black), Zak phase (red) and $\bar{\chi}$ (dashed blue).]{\includegraphics[width=35mm]{wan_essum.pdf}
}
}
\caption{Parameters used are: $t=1,t'=-2,m=0,\kappa'=0$. Adding disorder to an oscillating profile similar to the one in Fig.\ref{fig:wan1} shows that in general there is not enough information in $\chi_s$ mod $1$ to recover the Zak phase. }
\label{fig:wan2}
\end{figure}
...
\subfloat[${\rm Max}\bra{\psi_i}\sigma_x\ket{\psi_i}$ for $\xi_i >1/2$. \carlos{I don't know why the green line localizes so bad. I have to look further into it}]{\includegraphics[width=55mm]{lambdaL2.pdf}
}
}
...
\subfloat[Gap between the two eigenstates closest to $\xi = 1/2$]{\includegraphics[width=55mm]{linearBoundarysplit.pdf}
}
}
...
\subfloat[${\rm Max}\bra{\psi_i}\sigma_x\ket{\psi_i}$ for $\xi_i >1/2$.]{\includegraphics[width=55mm]{lambdaLinhloc.pdf}
}
}
\caption{$t = 1, t'= 2, m=0, \nu=2$. }
\label{lambdainh}
...
\centering
\makebox[0pt]{
\subfloat[${\rm Max}\bra{\psi_i}\sigma_x\ket{\psi_i}$ for $\xi_i >1/2$.]{
  \includegraphics[width=55mm]{bigsystemloc.pdf}
}
\subfloat[${\rm Log}_{10}(\chi - \gamma)$ ]{\includegraphics[width=55mm]{bigsystemerr.pdf}
}
}
\caption{$t = 1, t'= 2, m=0, \nu=2$. }
\label{lambdainh}
...
\makebox[0pt]{
\subfloat[ ${\rm Max}\bra{\psi_i}\sigma_x\ket{\psi_i}$ for $\xi_i >1/2$]{
  \includegraphics[width=55mm]{smallsystemloc.pdf}
}
\subfloat[${\rm Log}_{10}(\chi - \gamma)$.]{\includegraphics[width=55mm]{smallsystemerr.pdf}
}
}
\caption{$t = 1, t'= 2, m=0, \nu=2$. }
\label{lambdainh}
...
\makebox[0pt]{
\subfloat[${\rm Max}\bra{\psi_i}\sigma_x\ket{\psi_i}$ for $\xi_i >1/2$. ]{
  \includegraphics[width=55mm]{lambdaloc.pdf}
}
\subfloat[spectrum of $H_{ent}$]{\includegraphics[width=55mm]{lambdalocES.pdf}
}
}
\caption{$t = 1, t'= 2, m=0, \nu=2$. }
\label{lambdainh}
...
\centering
\makebox[0pt]{
\subfloat[$\gamma$ (red) and $\chi$ (blue) ]{
  \includegraphics[width=55mm]{nonquanterror2.pdf}
}
\subfloat[${\rm Log}_{10}(\chi - \gamma)$]{\includegraphics[width=55mm]{nonquanterror3.pdf}
}
}
