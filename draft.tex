...
A particular limit of our result for homogeneous systems~\ref{eqplusminus} was derived by Ryu and Hatsugai for a dimerized SSH chain~\cite{Ryu2006}. 
...
Let us first focus on systems with nearest-neighbor hopping, such as the SSH chain.
 one can obtain the Zak phase by ordering the eigenvalues of the ES, $\xi_1 < \xi_2 < ...$, and computing
\begin{equation}
