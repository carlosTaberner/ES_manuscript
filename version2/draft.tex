...
\emph{Outlook:} In the application of our results to topological systems in 1D we have focused on systems with translational invariance even though our results do not require it. For general spatially inhomogeneous systems the same bulk can present different boundaries such that the relation between bulk and boundary is not as straighforward as in the translational invariant case. Our results might be able to give more insight into this relation. 

In the field of higher-order topological insulators some systems can be characterized by a physical generalization of the bulk polarization to higher dimensions \cite{Benalcazar2017,Kang2019}. There is an open question wether a formulation in terms of twisted boundary conditions can be obtained, in which case our results might be able to generalize to higher dimensions.
