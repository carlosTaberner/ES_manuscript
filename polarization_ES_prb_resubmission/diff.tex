...
%DIF DEL polarization_ES_prb_submission/polarization_ES.tex     Fri Apr 16 21:32:56 2021
%DIF ADD polarization_ES_prb_resubmission/polarization_ES.tex   Fri Apr 16 21:32:56 2021
...
}\DIFdelend \DIFaddbegin \DIFadd{$\chi=0,1$, as the error we make is also exponentially small once we take the result modulo 1.  
}\DIFaddend 
...
, where it was related to the appearance of gapless modes. Below we will employ similar arguments to study the topology of 1D chains. 
}
...
\DIFaddbegin \section{\DIFadd{Degenerate EOS}}\label{app:loc}
...
\DIFaddend \section{Winding number in the SSH chain}
